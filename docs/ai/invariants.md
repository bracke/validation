...
|----|-----------|-----------------|--------|
| VAL-INV-001 | Finalized validators are immutable | Validation.Validators | proven |
...
| VAL-INV-026 | Rule outcomes derived by the engine from controlled output + state | Validation.Validators | proven |
